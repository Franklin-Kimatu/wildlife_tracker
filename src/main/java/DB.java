...
public class DB {
    ...
    static {
        try{
            ...
            String username = (dbUri.getUserInfo() ==null)? "franklin":dbUri.getUserInfo().split(":")[0];
...
//    public static Sql2o sql2o = new Sql2o("jdbc:postgresql://localhost:5432/wildlife_tracker", "franklin", "1234");
}